...
Release:    1%{?dist}
Summary:    The tool to help transition webhook backends from SNS to Argus.

Vendor:     Comcast
Packager:   Comcast
Group:      System Environment/Daemons
License:    ASL 2.0
URL:        https://github.com/xmidt-org/hecate
...
%description
The tool to help transition webhook backends from SNS to Argus.
